            ...
            <div class="flex justify-center items-center mb-8">
                <div class="md:w-[60em]">
                    ...
                    <div v-if="settings?.whatsapp" class="bg-white border border-slate-200 rounded-lg py-2 text-sm mb-4">
                        ...
                        <div class="grid grid-cols-3 items-center px-4 gap-x-4 py-2">
                            <div class="border-r">
                                <div>{{ $t('Whatsapp business account ID') }}</div>
                                <div>{{ settings.whatsapp?.waba_id }}</div>
                            </div>
                            <div class="border-r">
                                <div>{{ $t('Business verification') }}</div>
                                <div class="bg-slate-50 py-1 px-2 rounded-md w-[fit-content] text-xs">{{ 'UNKNOWN' }}</div>
                            </div>
                            <div>
...
<script setup>
    ...
    const props = defineProps({ settings: Object, embeddedSignupActive: Number, appId: String, configId: String });
