        ...
        <div class="flex-1">
            <ul class="pt-2 space-y-1 text-sm mb-2">
                ...
                <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/chats') ? 'bg-slate-50 text-black' : ''">
                    <Link rel="noopener noreferrer" href="/chats" class="flex items-center p-2 space-x-3 rounded-md">
                ...
                <li class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/canned-replies') ? 'bg-slate-50 text-black' : ''">
                    <Link rel="noopener noreferrer" href="/canned-replies" class="flex items-center p-2 space-x-3 rounded-md">
            ...
            <ul class="pb-4 space-y-1 text-sm mt-2">
                <li v-if="user.teams[0]['role'] === 'owner'" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/team') ? 'bg-slate-50 text-black' : ''">
                ...
                <li v-if="user.teams[0]['role'] === 'owner'" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/settings') ? 'bg-slate-50 text-black' : ''">
                ...
                <li v-if="user.teams[0]['role'] === 'owner'" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/billing') || $page.url.startsWith('/subscription') ? 'bg-slate-50 text-black' : ''">
                ...
                <li v-if="user.teams[0]['role'] === 'owner'" class="hover:bg-slate-50 hover:text-black rounded-[5px] px-2 truncate">
                    <Link rel="noopener noreferrer" href="/developer" class="flex items-center p-2 space-x-3 rounded-md">
                        ...
                        <span :class="menuIconsOnly ? 'hidden' : ''">{{ $t('Developer') }}</span>
                    </Link>
                </li>
            </ul>
        </div>
