<template>
    <aside class="md:flex flex-col h-full bg-white hidden relative" :class="menuIconsOnly ? 'w-20' : 'w-80'">
        <button @click="toggleMenu" class="absolute right-[-18px] top-[32px] bg-slate-100 px-2 py-2 rounded-full shadow-md">
        ...
        <Menu :config="props.config" :user="props.user" :organization="props.organization" :organizations="props.organizations" :menuIconsOnly="menuIconsOnly"></Menu>
    </aside>
</template>
<script setup>
